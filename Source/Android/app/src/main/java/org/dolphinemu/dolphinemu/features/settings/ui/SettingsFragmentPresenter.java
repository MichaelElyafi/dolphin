...
public final class SettingsFragmentPresenter
{
  ...
  private void addGeneralSettings(ArrayList<SettingsItem> sl)
  {
	...
	jitFollowBranch = coreSection.getSetting(SettingsFile.KEY_JIT_FOLLOW_BRANCH);
	...
	sl.add(new CheckBoxSetting(SettingsFile.KEY_JIT_FOLLOW_BRANCH, Settings.SECTION_INI_CORE, R.string.jit_follow_branch, R.string.jit_follow_branch_description, true, jitFollowBranch));
